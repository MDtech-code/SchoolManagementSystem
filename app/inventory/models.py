...
class Item(TimeStampedModel):
    category = models.ForeignKey('common.Category', on_delete=models.CASCADE, related_name='items')
...
class Issuance(TimeStampedModel):
    department = models.ForeignKey('academic.Department', on_delete=models.CASCADE, related_name='issuances')
...
class ReturnFromDepartment(TimeStampedModel):
    department = models.ForeignKey('academic.Department', on_delete=models.CASCADE, related_name='returns')
