...
from core.utils.choices import GENDER_CHOICES, BLOOD_GROUP_CHOICES, PICK_N_DROP_CHOICES, MARITAL_STATUS_CHOICES, \
    HEALTH_CHOICES, IMMUNIZATION_CHOICES, GUARDIAN_RELATION_CHOICES, ENROLLMENT_CHOICES,ADMISSION_TYPE_CHOICES, VOUCHER_TYPE_CHOICES, SUBJECT_CHOICE
